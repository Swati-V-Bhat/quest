...
export interface Quest {
  ...
  isAiGenerated?: boolean; // True if quest was generated by AI, false if manually created
...
export interface User {
  ...
  totalXP?: number;
  currentLevel?: number;
  // Note: totalQPs and rankTitle are stored in gamification/{uid} collection, not on user document
  isPrivate?: boolean;
